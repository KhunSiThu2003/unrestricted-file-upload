...
<section class="w-full mx-auto px-4 sm:px-6 lg:px-8 py-6 sm:py-8">
    ...
    <div class="w-full glass-card rounded-2xl overflow-hidden border border-emerald-500/20 bg-gradient-to-b from-neutral-900/50 to-neutral-900/30">
                <!-- Panel Header -->
                <div class="px-6 py-4 sm:px-8 sm:py-6 border-b border-emerald-500/10 bg-gradient-to-r from-emerald-900/10 to-emerald-900/5">
                    <div class="flex flex-col sm:flex-row sm:items-center justify-between gap-3">
                        <div class="flex items-center gap-3">
                            <div class="w-10 h-10 rounded-xl bg-gradient-to-br from-emerald-600 to-emerald-700 flex items-center justify-center">
                ...
                <div class="p-6 sm:p-8">
                    ...
                    <form id="secure-upload-form" class="space-y-6">
                        <!-- File Upload Area -->
                        <div class="border-2 border-dashed border-emerald-500/20 rounded-2xl p-6 sm:p-8 text-center hover:border-emerald-500/40 transition-colors duration-300 bg-neutral-900/30">
                            ...
                            <label for="secure_file" class="cursor-pointer block">
                                ...
                                <div class="inline-flex items-center gap-2 px-4 py-2 rounded-lg bg-emerald-600 hover:bg-emerald-500 text-white font-medium transition-all duration-300 border border-emerald-500/30">
                            ...
                            <div id="selected-file" class="mt-4 hidden">
                                <div class="inline-flex items-center gap-3 px-4 py-2 rounded-lg bg-emerald-900/30 border border-emerald-500/20">
                        ...
                        <div class="grid grid-cols-2 sm:grid-cols-4 gap-3">
                            <div class="bg-neutral-900/40 rounded-xl p-3 text-center border border-emerald-500/10">
                        ...
                        <!-- Upload Button -->
                        <button type="submit" 
                                class="w-full group relative inline-flex items-center justify-center gap-2 px-6 py-3 rounded-xl bg-gradient-to-r from-emerald-600 to-emerald-700 hover:from-emerald-500 hover:to-emerald-600 text-white font-semibold transition-all duration-300 border border-emerald-500/30 overflow-hidden">
                            ...
                            <i class="fas fa-cloud-upload-alt text-lg relative z-10"></i>
                            <span class="relative z-10">Upload Securely</span>
                        </button>
                    </form>
                </div>
            </div>
...
<div id="upload-progress" class="fixed inset-0 bg-black/70 flex items-center justify-center z-50 hidden">
    <div class="glass-card rounded-2xl p-6 max-w-xs w-full mx-4 border border-emerald-500/30">
        <div class="text-center">
            ...
            <div class="w-full bg-neutral-800 rounded-full h-2 mb-4">
                <div id="progress-bar" class="bg-gradient-to-r from-emerald-500 to-emerald-400 h-2 rounded-full w-0 transition-all duration-300"></div>
            </div>
